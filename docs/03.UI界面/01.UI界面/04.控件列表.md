...
- !TextBlock
  ...
  # 文本布局
  textAlignment: Center         # 文本横向对齐：Left/Center/Right
  horizontalContentAlignment: Left  # 文本横向对齐：Left/Center/Right
  verticalContentAlignment: Top     # 文本竖向对齐：Top/Center/Bottom
  contentAlignment: left_top        # 文本对齐：Left/Center/Right Top/Center/Bottom
  lineHeight: 10                # 行高
  maxLines: 5                   # 最大行数
  minLines: 1                   # 最小行数
